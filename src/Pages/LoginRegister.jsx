...
function LoginRegister() {
 ...
 const handleRoleSelectionSubmit = () => {
  ...
  const selectedRoleToken = roles.find(
 ...
 const handleOtpSubmit = () => {
  ...
  fetch(
   'http://20.235.246.99:8000/api/v1/verifyOTP',
   otpVerificationRequestOptions
  )
        ...
        <Row className="d-flex justify-content-evenly">
         <Col lg={6}>
          <h4 className="text-center mb-5">
           <div className="custom-tabs d-flex justify-content-evenly">
            <div
             className={`custom-tab ${activeTab === 'login' ? 'active' : ''}`}
